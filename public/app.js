...
var app = new Vue({
  ...
  data: {
    ...
    sensitive:false,
    openUsersList:true,
    words:["أن", "جزيرة", "من", "جزائر", "الهند", "التي", "تحت", "خط", "الاستواء", "وهي", "الجزيرة", "التي", "يتولد", "بها", "الإنسان", "من", "غير", "أم", "ولا", "أب", "وبها", "شجر", "يثمر", "نساء", "وهي", "التي", "ذكر", "المسعودي", "أنها", "جزيرة", "الوقواق", "لان", "تلك", "الجزيرة", "اعدل", "بقاع", "الأرض", "هواء", "أتممها", "لشروق", "النور", "الأعلى", "عليها", "كان", "ذلك", "خلاف", "ما", "يراه", "جمهور", "الفلاسفة"],
    input:'',
    word:'',
    me:{},
    users:[],
